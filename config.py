...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7643677854:AAFgcQdIz6LYd1zFRVqcPxXMJX5jGoTuQQc")
APP_ID = int(os.environ.get("APP_ID", "25475508")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "22a9a96bbb571455c4b4f4e8244c1b58") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-2605386840")) #Your db channel Id
OWNER = os.environ.get("OWNER", "ajjubhai_86") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "5795114320")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://thecrazyhackerrraj:ruplalghunawat@cluster0.gk7qh8r.mongodb.net/")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")
#--------------------------------------------
FSUB_LINK_EXPIRY = int(os.getenv("FSUB_LINK_EXPIRY", "10"))  # 0 means no expiry
BAN_SUPPORT = os.environ.get("BAN_SUPPORT", "https://t.me/xghost_001")
